...
1. Follow [the steps of Step 1](https://docs.aws.amazon.com/chatbot/latest/adminguide/getting-started.html#chat-client-setup){target=_blank} in the category "Setting up AWS Chatbot with Slack"
...
* `slackWorkspaceId`: string - The ID that AWS generates for [your workspace]()
